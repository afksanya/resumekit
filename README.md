...
PDF export prints the selected HTML template through a headless browser when Chrome, Edge, or Chromium is available. If no browser is found, ResumeKit falls back to a simpler built-in PDF renderer.
